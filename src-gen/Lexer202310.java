...
public final class Lexer202310 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=229;
      ((gold.structures.map.GHashTableMap)translation).put("pick",'i');
      $line=230;
      ((gold.structures.map.GHashTableMap)translation).put("moveToThe",'o');
      $line=231;
      ((gold.structures.map.GHashTableMap)translation).put("moveInDir",'b');
      $line=232;
      ((gold.structures.map.GHashTableMap)translation).put("jumpToThe",'j');
      $line=233;
      ((gold.structures.map.GHashTableMap)translation).put("jumpInDir",'d');
      $line=234;
      ...
      $line=248;
      ((gold.structures.map.GHashTableMap)translation).put("canMoveInDir",'e');
      $line=249;
      ...
      $line=251;
      ((gold.structures.map.GHashTableMap)translation).put("canJumpToThe",'l');
      $line=252;
